...
namespace Mirle.Agv.Utmc.View
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.ucCurrentTransferStepType = new Mirle.Agv.Utmc.UcLabelTextBox();
            this.ucOpPauseFlag = new Mirle.Agv.Utmc.UcLabelTextBox();
            this.ucPauseFlag = new Mirle.Agv.Utmc.UcLabelTextBox();
            this.ucReserveFlag = new Mirle.Agv.Utmc.UcLabelTextBox();
            this.ucErrorFlag = new Mirle.Agv.Utmc.UcLabelTextBox();
            this.ucCommanding = new Mirle.Agv.Utmc.UcLabelTextBox();
            this.gbPerformanceCounter = new System.Windows.Forms.GroupBox();
            this.ucHeadAngle = new Mirle.Agv.Utmc.UcLabelTextBox();
            this.ucRCstId = new Mirle.Agv.Utmc.UcLabelTextBox();
            this.ucLCstId = new Mirle.Agv.Utmc.UcLabelTextBox();
            this.ucMapAddressId = new Mirle.Agv.Utmc.UcLabelTextBox();
            this.ucRobotHome = new Mirle.Agv.Utmc.UcLabelTextBox();
            this.ucCharging = new Mirle.Agv.Utmc.UcLabelTextBox();
            this.ucWifiSignalStrength = new Mirle.Agv.Utmc.UcLabelTextBox();
            this.ucCommandCount = new Mirle.Agv.Utmc.UcLabelTextBox();
            this.ucSoc = new Mirle.Agv.Utmc.UcLabelTextBox();
            ...
            this.ucMoveMovingIndex = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucMoveMoveState = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucMovePauseStop = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucMoveReserveStop = new Mirle.Agv.Utmc.UcVerticalLabelText();
            ...
            this.ucAddress = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucChargeCount = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucCurransferStepType = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucStepsCount = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucIsSimulation = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucIsCharger = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucIsArrivalCharge = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucIsLowPowerStartChargeTimeout = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucIsLowPower = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucIsOptimize = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucIsVehicleIdle = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucAutoState = new Mirle.Agv.Utmc.UcVerticalLabelText();
            ...
            this.ucIsCharging = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucIsHome = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucIsSleepByAskReserveFail = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucIsMoveEnd = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucIsMoveStep = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucIsAskReservePause = new Mirle.Agv.Utmc.UcVerticalLabelText();
            ...
            this.ucTransferCommandTransferStep = new Mirle.Agv.Utmc.UcVerticalLabelText();
            this.ucTransferCommandEnrouteState = new Mirle.Agv.Utmc.UcVerticalLabelText();
